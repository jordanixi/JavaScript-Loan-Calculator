...
<td><input id="postcode" onchange="calculate();"></td>
<tr><th>Approximate Payments:</th>
<td><button onclick="calculate();">Calculate</button></td></tr>
<tr><td>Monthly payment:</td>
<td>&pound<span class="output" id="payment"></span></td></tr>
<tr><td>Total payment:</td>
<td>&pound<span class="output" id="total"></span></td></tr>
<tr><td>Total interest:</td>
<td>&pound<span class="output" id="totalinterest"></span></td></tr>
...
if (isFinite(monthly)) {
   ...
   totalinterest.innerHTML = ((monthly*payments)-principal).toFixed(2);
    ...
    save(amount.value, apr.value, years.value, postcode.value);
    
    Advertise: find and display local lenders, but ignore network errors
    try { // Catch any errors that occur within these curly braces
        getLenders(amount.value, apr.value, years.value, postcode.value);
    }
...
function save(amount, apr, years, postcode) {
if (window.localStorage) { // Only do this if the browser supports it
    localStorage.loan_amount = amount;
    localStorage.loan_apr = apr;
    localStorage.loan_years = years;
    localStorage.loan_postcode = postcode;
...
document.getElementById("postcode").value = localStorage.loan_postcode;
}
};
...
function getLenders(amount, apr, years, postcode) {
...
var url = "getLenders.php" +
        ...
        "&post=" + encodeURIComponent(postcode);
